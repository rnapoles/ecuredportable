...
function BuidMenu(){
	 ...
	 //wikihelper.debug("BuidMenu");
	 
	 $('.contenedor_derecho2').css('width','95%');
	 //$('.contenedor_derecho2').after("<b>Hello</b>");
	 
	 //$('.contenedor_derecho2').css('float','inherit');;
	 if(size==0)  {
