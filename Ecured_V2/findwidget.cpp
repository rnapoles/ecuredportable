    ...
    , appPalette(qApp->palette())
{
    ...
    labelWrapped->setText(tr("<img src=\":/images/wrap.png\">&nbsp;no hay más coincidencias"));
...
void FindWidget::setTextWrappedVisible(bool visible)
{
   // TRACE_OBJ
    if(visible){
        QMessageBox msg;
        msg.setText("No hay más coincidencias en el texto para la palabra buscada");
        msg.exec();
    }
